	...
	<div id="layoutSidenav_content">
		<main>
			...
			<div
				...
				<h1 class="mt-4">Insertar proveedor</h1>
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item active"> Permite registrar un nuevo proveedor en el sistema</li>
				</ol>
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="card mb-4">
							<div class="card-header text-white bg-dark">
								<i class="fas fa-table"></i> Insertar un nuevo proveedor
							</div>
							<div class="card-body">
								...
								<div class="container">
									...
									<div id="error" class="alert alert-danger visually-hidden"
										role="alert">Error al registrar el proveedor, verifique
											que el NIT no exista ya en el sistema</div>
