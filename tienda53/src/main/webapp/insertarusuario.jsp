...
<body>
	...
	<div class="col-md-8 col-md-offset-2 gtco-heading text-center">
		<h2><i class="fas fa-plus-circle"></i> Datos del nuevo usuario</h2>
		</div>
	</div>
...
<form>
  <div class="form-group col-md-6">
    ...
    <input type="number" class="form-control" id="cedula_usuario" placeholder="Cedula" required>
  </div>
  <div class="form-group col-md-6">
    <label for="exampleInputPassword1">Email</label>
    <input type="email" class="form-control" id="email_usuario" placeholder="Email" required>
  </div>
  <div class="form-group col-md-6">
    <label for="exampleInputEmail1">Nombre completo</label>
    <input type="text" class="form-control" id="nombre_usuario" placeholder="Nombre completo" required>
  </div>
  <div class="form-group col-md-6">
...
<!-- form end -->
	...
	<footer>
	<div class="gtco-footer container gtco-copyright bg-dark  fixed-bottom">
				<div class="gtco-container">
					<div class="row">
