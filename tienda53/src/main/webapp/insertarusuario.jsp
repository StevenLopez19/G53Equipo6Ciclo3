...
<body>
				...
				<div class="gtco-container">
					<div class="row">
						<div class=" text-center menu-1">
							<ul>
								<li class="active"><a href="insertarusuario.jsp"><i
								...
								<li><a href="buscarusuario.jsp"><i
										class="fas fa-search"></i>Buscar usuario</a></li>
								<li><a href="listausuarios.jsp"><i
										class="fas fa-search"></i>Listar todos los usuarios</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<div class="container ">
		<div id="error" class="alert alert-danger visually-hidden col-md-4"
			role="alert">Error al crear el usuario, verifique que no exista
